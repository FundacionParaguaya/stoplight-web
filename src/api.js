  ...
  axios({
    ...
    data: JSON.stringify({
      query:
        ...
        '{ families(organizations: $organizations, name:$name, page:$page, sortBy:$sortBy, sortDirection:$sortDirection ){content {familyId name code birthDate documentTypeText  documentNumber} totalPages totalElements }}',
      variables: {
        organizations,
        name,
        page,
