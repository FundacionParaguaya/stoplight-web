...
export const loadFamilies = () => dispatch => {
  fetch(`https://testing.backend.povertystoplight.org/graphql`, {
    ...
    body: JSON.stringify({
      query:
        'query { familiesNewStructure{ code user { username } name country { country } organization { code } countFamilyMembers familyMemberDTOList{ firstName gender birthDate } } }'
    })
  })
    .then(res => res.text())
